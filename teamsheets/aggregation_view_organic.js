...
const TABLE_CONFIG = {
  ...
  tables: [
    ...
    {
      name: 'Client_Projects_Per_Organic_Product',
      headerRow: 76,
      startRange: 'B76:M103'
    },
    {
  ...
  projectsTables: {
    ...
    columnMappings: {
      'SMM': {
        'SMM': 'Primary_Full_Name',
        'Asana Projects': 'Project',
        'SMM hours done (relative)': 'Primary_Hours_Done_Relative',
        'SMM Support': 'Support_Full_Name',
        'Support hours done (relative)': 'Support_Hours_Done_Relative',
        'SMM substitute': 'Substitute_Full_Name',
        'Rest hours done': 'Rest_Hours_Done',
        'SMM hours plan. (rel. in %)': 'Primary_Hours_Planned',
        ...
        'Target Hours SMM': 'Primary_Target_Hours',
    ...
    try {
      ...
      for (let i = 1; i < data.length; i++) {
        if (data[i][0]) {
          ...
          mappedData[2] = rangeConfig.type === 'SMM' ? 'SMM' : 
